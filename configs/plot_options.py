...
def options_plot (analysis, channel, all_procs) :
    ...
    if analysis == "ttH" :
        ...
        elif fakes in all_procs       : dprocs[fakes]       = {"color" :  12, "fillStype" : 3345, "label" : "Non-prompt"  , "make border" : True}
        ...
        if channel in ["0l_2tau", "1l_1tau", "2los_1tau"] :
            ...
            del dprocs["TT"]
            dprocs["TT"]                                  = {"color" : 114, "fillStype" : 1001, "label" : 'TT + jets'   , "make border" : True}
            del dprocs[fakes]
            dprocs[fakes]                                 = {"color" :   1, "fillStype" : 3005, "label" : "Mis."        , "make border" : True}
    ...
    if analysis == "ttH" :
        ...
        info_channel = {
            ...
            "3l_0tau"   : {
                ...
                "useLogPlot" : False,
                "label" : '3l + 0#tau_{h}',
                "labelX" : "BDT", "cats" : [""] # "ch1", "ch1", "ch1", "ch1", "ch1", "ch1",
                },
            "3l_0tau_ttH" : {
                "minY" : 0,    "maxY" :  10.,
                "minYerr": 0.501, "maxYerr" : 1.59,
            ...
            "3l_0tau_rest" : {
                ...
                "label" : '3l + 0#tau_{h}, ttH region',
                "labelX" : "DNN bin#",
                "cats" : ["ch1", "ch2", "ch3", "ch4", "ch5", "ch6", "ch7", "ch8"]
                },
            ...
            "0l_2tau"   : { "minY" : 0.07,  "maxY" :  30000., "minYerr": -0.6,  "maxYerr" : 2.85, "useLogPlot" : True,  "label" : '2l + 2#tau_{h}', "labelX" : "BDT", "cats" : [""]},
            "1l_1tau"   : {
                "minY" : 0.07,  "maxY" :  500000.,
                "minYerr": -0.6,  "maxYerr" : 2.85,
                "useLogPlot" : True,
                "label" : '1l + 1#tau_{h}',
                "labelX" : "BDT", "cats" : [""]
...
def list_channels_draw(analysis) :
    if analysis == "ttH" :
        sigs = ["ttH", "tHq", "tHW", "VH", "ggH", "qqH", "TTWH", "TTZH"]
        #conversions = "conversions"
        #fakes       = "fakes_data"
        flips       = "data_flips"
        conversions = "Convs"
        ...
        "3l_0tau"   : {
            ...
            "bkg_procs_from_MC"  : ["TTW", "TTWW", "TTZ", "EWK", "WZ", "ZZ", "Rares", conversions, "tHq", "tHW", "VH"],
        ...
        #"1l_2tau"   : { "bkg_proc_from_data" : [fakes       ], "bkg_procs_from_MC"  : ["TTW", "TTWW", "TTZ", "WZ", "ZZ","EWK",  "Rares", conversions], "signal" : ["ttH", "tHq", "tHW", "VH",  "VH", "HH", "TTWH", "TTZH"]}, # "ggH", "qqH",
        "2los_1tau" : {
